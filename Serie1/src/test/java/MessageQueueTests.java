...
public class MessageQueueTests {
    ...
    private final MessageQueue<String> msgQ = new MessageQueue<>();
    ...
    @Test
    public void testMessageCanceled() throws InterruptedException {
        /// Arrange
        final PlaceHolder<Optional<String>> res = new PlaceHolder<>();

        final Helper.InterruptibleRunnable r1 = () -> msgQ.send("Thread 1").tryCancel(),
                r2 = () -> {
                    try {
                        Thread.sleep(2_000);
                        res.value = msgQ.receive(5_000);
